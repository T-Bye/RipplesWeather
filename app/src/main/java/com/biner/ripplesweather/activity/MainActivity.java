...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (DBUtil.loadCity().size()==0){
            new writeDataCity().execute();
        }
    ...
    private class writeDataCity extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            String address = "https://api.heweather.com/x3/citylist?search=allchina&key=b2ad4353d8eb4e048c438de6666f1153";
            String JsonResult = HttpUtil.sendHttpRequest(address);
            return JsonResult != null && Utility.jsonCityResponse(JsonResult);
        }
